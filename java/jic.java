...
public class jic {
	 ...
	 */
	public native static int p4denc32(int[] in, int n, byte[] out, int start);
	...
	public native static int p4d1enc32(int[] in, int n, byte[] out, int start);
	...
	/*
	 * public native static int bitpack128v32( int[] in, int n, byte[] out, int
	 * b); public native static int bitunpack128v32( byte[] in, int n, int[]
	 * out, int b); public native static int bitpack256v32( int[] in, int n,
	 * byte[] out, int b); public native static int bitunpack256v32( byte[] in,
	 * int n, int[] out, int b);
	 */
	...
	/*
	 * public native static int bitdpack128v32( int[] in, int n, byte[] out, int
	 * start, int b); public native static int bitdunpack128v32( byte[] in, int
	 * n, int[] out, int start, int b); public native static int bitdpack256v32(
	 * int[] in, int n, byte[] out, int start, int b); public native static int
	 * bitdunpack256v32( byte[] in, int n, int[] out, int start, int b);
	 */
	...
	/*
	 * public native static int bitd1pack128v32( int[] in, int n, byte[] out,
	 * int start, int b); public native static int bitd1unpack128v32( byte[] in,
	 * int n, int[] out, int start, int b); public native static int
	 * bitd1pack256v32( int[] in, int n, byte[] out, int start, int b); public
	 * native static int bitd1unpack256v32( byte[] in, int n, int[] out, int
	 * start, int b);
	 */
	...
	static {
		try {
			...
			System.load("/usr/lib/libic.so");
		} catch (UnsatisfiedLinkError e) {
			System.err
					.println("can't load Native TurboPFor from '" + System.getProperty("java.library.path") + "'" + e);
			System.exit(1);
		}
	}
}
