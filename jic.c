...
JNIEXPORT jint JNICALL Java_jic_p4enc32(           JNIEnv *env, jclass cls,  jintArray _in, jint n, jbyteArray _out                    ) { JNIENC(p4enc32,              _in, n, _out          ); } JNIEXPORT jint JNICALL JavaCritical_jic_p4enc32(          jint i,  jint *in, jint n, jint o, jbyte *out                     ) { return p4enc32(           (unsigned *)in, n, (unsigned char *)out          ) - (unsigned char *)out; }
...
JNIEXPORT jint JNICALL Java_jic_p4denc32(JNIEnv *env, jclass cls, jbyteArray _in, jint n, jintArray _out, jint start) { JNIENCS(p4denc32, _in, n, _out, start); } JNIEXPORT jint JNICALL JavaCritical_jic_p4denc32(jint i, jbyte *in, jint n, jint o, jint *out, jint start) { return p4denc32((unsigned char *)in, n, (unsigned *)out, start) - (unsigned char *)in; }
...
JNIEXPORT jint JNICALL Java_jic_p4d1enc32(JNIEnv *env, jclass cls, jbyteArray _in, jint n, jintArray _out, jint start) { JNIENCS(p4d1enc32, _in, n, _out, start); } JNIEXPORT jint JNICALL JavaCritical_jic_p4d1enc32(jint i, jbyte *in, jint n, jint o, jint *out, jint start) { return p4d1enc32((unsigned char *)in, n, (unsigned *)out, start) - (unsigned char *)in; }
